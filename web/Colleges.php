    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Arts Colleges">
              <img src="icons/Education/Arts Colleges.jpg" height="80" width="80">
              <p class="text-para">Arts Colleges</p>
          </a>
        </div>
           <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Commerce Colleges">
              <img src="icons/Education/Commerce Colleges.jpg" height="70" width="70">
              <p class="text-para">Commerce Colleges</p>
          </a>
        </div>
           <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Diploma Colleges">
              <img src="icons/Education/Diploma Colleges.jpg" height="70" width="70">
              <p class="text-para">Diploma Colleges</p>
          </a>
        </div>

          <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Engineering">
              <img src="icons/Education/Engineering.jpg" height="70" width="70">
              <p class="text-para">Engineering</p>
          </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Hotel Management">
              <img src="icons/Education/Hotel Management.jpg" height="70" width="70">
              <p class="text-para">Hotel Management</p>
          </a>
        </div>

         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Medical">
              <img src="icons/Education/Medical.jpg" height="70" width="70">
              <p class="text-para">Medical</p>
          </a>
        </div>
       ...
       <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Science Colleges">
              <img src="icons/Education/Science Colleges.jpg" height="80" width="80">
              <p class="text-para">Science Colleges</p>
          </a>
        </div>
