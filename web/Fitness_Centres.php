    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Gym">
          		<img src="icons/Fitness Centres/Gym.jpg" height="70" width="70">
          		<p class="text-para">Gym</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Yoga Classes">
          <img src="icons/Fitness Centres/Yoga Classes.jpg" height="70" width="70">
          <p class="text-para">Yoga Classes</p>
        </a>
        </div>
