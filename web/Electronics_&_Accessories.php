    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Camera & Equipments">
          		<img src="icons/Electronics & Accessories/Camera & Equipments.jpg" height="70" width="70">
          		<p class="text-para">Camera & Equipments</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=CCTV & Products">
          <img src="icons/Electronics & Accessories/CCTV & Products.jpg" height="70" width="70">
          <p class="text-para">CCTV & Products</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Computers & Laptop">
          <img src="icons/Electronics & Accessories/Computers & Laptops.jpg" height="70" width="70">
