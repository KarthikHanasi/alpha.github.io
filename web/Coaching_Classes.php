    ...
    <div class="container shadow">
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Accountancy Classes">
          		<img src="icons/Coaching Classes/Accountancy Classes.jpg" height="70" width="70">
          		<p class="text-para">Accountancy Classes</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=CET Classes">
          <img src="icons/Coaching Classes/CET Classes.jpg" height="70" width="70">
          <p class="text-para">CET Classes</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=GATE Classes">
          <img src="icons/Coaching Classes/GATE Classes.jpg" height="70" width="70">
          <p class="text-para">GATE Classes</p>
        </a>
        </div>
          <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=GRE Classes">
          <img src="icons/Coaching Classes/GRE Classes.jpg" height="70" width="70">
          <p class="text-para">GRE Classes</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Higher Primary Classes">
          <img src="icons/Coaching Classes/Higher Primary Classes.jpg" height="70" width="70">
          <p class="text-para">Higher Primary Classes</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=IELTS Classes">
          <img src="icons/Coaching Classes/IELTS Classes.jpg" height="70" width="70">
          <p class="text-para">IELTS Classes</p>
        </a>
        </div>
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Primary Classes">
          <img src="icons/Coaching Classes/Primary Classes.jpg" height="70" width="70">
          <p class="text-para">Primary Classes</p>
        </a>

        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=PUC Classes">
          <img src="icons/Coaching Classes/PUC Classes.jpg" height="70" width="70">
          <p class="text-para">PUC Classes</p>
        </a>
        </div>
