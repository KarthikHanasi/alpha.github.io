    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Four wheelers">
          		<img src="icons/Automobiles/Four wheelers.jpg" height="80" width="80">
          		<p class="text-para">Four wheelers</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Two wheelers">
          <img src="icons/Automobiles/Two wheelers.jpg" height="80" width="80">
          <p class="text-para">Two wheelers</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Tyre dealers">
          <img src="icons/Automobiles/Tyre dealers.jpg" height="80" width="80">
          <p class="text-para">Tyre dealers</p>
        </a>
        </div>
