  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-sm-2">
        	<a href="category_details.php?id=Instrument Classes">
          		<img src="icons/Music Classes & Instruments/Instrument Classes.jpg" height="70" width="70">
          		<p class="text-para">Instrument Classes</p>
      		</a>
        </div>

        <div class="col-sm-2">
          <a href="category_details.php?id=Instrument Shops">
          <img src="icons/Music Classes & Instruments/Instrument Shops.jpg" height="70" width="70">
          <p class="text-para">Instrument Shops</p>
        </a>
        </div>

        <div class="col-sm-2">
          <a href="category_details.php?id=Vocal Classes">
          <img src="icons/Music Classes & Instruments/Vocal Classes.jpg" height="70" width="70">
          <p class="text-para">Vocal Classes</p>
        </a>
        </div>
