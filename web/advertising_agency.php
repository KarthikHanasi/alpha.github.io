    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Ad Agencies">
          		<img src="icons/Advertising Agencies/Ad designing.jpg" height="70" width="70">
          		<p class="text-para">Ad designing</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=News paper & magazine">
          <img src="icons/Advertising Agencies/News paper & Magazine.jpg" height="70" width="70">
          <p class="text-para">News paper & Magazine</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Tv & Radio">
          <img src="icons/Advertising Agencies/Tv & Radio.jpg" height="70" width="70">
          <p class="text-para">Tv & Radio</p>
        </a>
        </div>
