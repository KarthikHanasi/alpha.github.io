    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=3 star hotels">
          		<img src="icons/Hotels/3 star hotels.jpg" height="70" width="70">
          		<p class="text-para">3 star hotels</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=5 star hotels">
          <img src="icons/Hotels/5 star hotels.jpg" height="70" width="70">
          <p class="text-para">5 star hotels</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Budget hotels">
          <img src="icons/Hotels/Budget hotels.jpg" height="70" width="70">
          <p class="text-para">Budget hotels</p>
        </a>
        </div>
