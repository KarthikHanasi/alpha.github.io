    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Non Veg">
          		<img src="icons/Caterers/Non Veg.jpg" height="70" width="70">
          		<p class="text-para">Non Veg</p>
      		</a>
        </div>

        <div class="col-sm-2">
          <a href="category_details.php?id=Veg">
          <img src="icons/Caterers/Veg.jpg" height="70" width="70">
          <p class="text-para">Veg</p>
        </a>
        </div>
      </div>
