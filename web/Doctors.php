    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Ayurvedic">
          		<img src="icons/Doctors/Ayurvedic.jpg" height="70" width="70">
          		<p class="text-para">Ayurvedic</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Chest Specialists">
          <img src="icons/Doctors/Chest Specialists.jpg" height="70" width="70">
          <p class="text-para">Chest Specialists</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Child Specialists">
          <img src="icons/Doctors/Child Specialists.jpg" height="70" width="70">
          <p class="text-para">Child Specialists</p>
        </a>
        </div>
          <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Cosmetic Surgeons">
          <img src="icons/Doctors/Cosmetic Surgeons.jpg" height="70" width="70">
          <p class="text-para">Cosmetic Surgeons</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Dietitians">
          <img src="icons/Doctors/Dietitians.jpg" height="70" width="70">
          <p class="text-para">Dietitians</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Eye Specialists">
          <img src="icons/Doctors/Eye Specialists.jpg" height="70" width="70">
          <p class="text-para">Eye Specialists</p>
        </a>
        </div>
       ...
       <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Homeopathic">
          <img src="icons/Doctors/Homeopathic.jpg" height="70" width="70">
          <p class="text-para">Homeopathic</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Neurologists">
          <img src="icons/Doctors/Neurologists.jpg" height="70" width="70">
          <p class="text-para">Neurologists</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Physiotherapists">
          <img src="icons/Doctors/Physiotherapists.jpg" height="70" width="70">
          <p class="text-para">Physiotherapists</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Psychiatrists">
          <img src="icons/Doctors/Psychiatrists.jpg" height="70" width="70">
          <p class="text-para">Psychiatrists</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Sexologists">
          <img src="icons/Doctors/Sexologists.jpg" height="70" width="70">
          <p class="text-para">Sexologists</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Thyroid Specialists">
           <img src="icons/Doctors/Thyroid Specialists.jpg" height="70" width="70">
           <p class="text-para">Thyroid Specialists</p>
          </a>
        </div>
       ...
       <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Urologists">
           <img src="icons/Doctors/Urologists.jpg" height="70" width="70">
           <p class="text-para">Urologists</p>
        </a>
        </div>
