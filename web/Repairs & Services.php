    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
         ...
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Bike">
              <img src="icons/Repairs & Services/Bike.jpg" height="70" width="70">
              <p class="text-para">Bike</p>
          </a>
        </div>
    
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Car">
          		<img src="icons/Repairs & Services/Car.jpg" height="70" width="70">
          		<p class="text-para">Car</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Computers & Laptops">
          <img src="icons/Repairs & Services/Computers & Laptops.jpg" height="70" width="70">
          <p class="text-para">Computers & Laptops</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Other Electronics">
          <img src="icons/Repairs & Services/Other Electronics.jpg" height="70" width="70">
          <p class="text-para">Other Electronics</p>
        </a>
        </div>
