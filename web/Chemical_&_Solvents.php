    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Agro chemicals">
          		<img src="icons/Chemical & Solvents/Agro chemicals.jpg" height="70" width="70">
          		<p class="text-para">Agro chemicals</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Industrial Chemicals">
          <img src="icons/Chemical & Solvents/Industrial Chemicals.jpg" height="70" width="70">
          <p class="text-para">Industrial Chemicals</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Laboratory Chemicals">
          <img src="icons/Chemical & Solvents/Laboratory Chemicals.jpg" height="70" width="70">
          <p class="text-para">Laboratory Chemicals</p>
        </a>
        </div>
      </div>
