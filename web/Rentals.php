      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Bike">
          		<img src="icons/Rentals/Bike.jpg" height="80" width="80">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          ...
          <img src="icons/Rentals/Camera & Equipments.jpg" height="80" width="80">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          ...
          <img src="icons/Rentals/Car.jpg" height="80" width="80">
          <p class="text-para">Car</p>
        </a>
        </div>
          <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=PG">
          <img src="icons/Rentals/PG.jpg" height="80" width="80">
          <p class="text-para">PG</p>
        </a>
        </div>
