    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=International">
          		<img src="icons/Courier Services/International.jpg" height="70" width="70">
          		<p class="text-para">International</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Local">
          <img src="icons/Courier Services/Local.jpg" height="70" width="70">
          <p class="text-para">Local</p>
        </a>
        </div>
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=National">
          <img src="icons/Courier Services/National.jpg" height="70" width="70">
          <p class="text-para">National</p>
        </a>
        </div>
