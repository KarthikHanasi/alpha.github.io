    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Agricultural Equipments">
          		<img src="icons/Agriculture/Agricultural Equipments.jpg" height="70" width="70">
          		<p class="text-para">Agricultural Equipments</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Agro Products">
          <img src="icons/Agriculture/Agro Products.jpg" height="70" width="70">
          <p class="text-para">Agro Products</p>
        </a>
        </div>
      </div>
