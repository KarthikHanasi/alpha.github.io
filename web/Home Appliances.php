    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Fridge & Washing machines">
          		<img src="icons/Home Appliances/Fridge & Washing machines.jpg" height="70" width="70">
          		<p class="text-para">Fridge & Washing machines</p>
      		</a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Furnitures">
          <img src="icons/Home Appliances/Furnitures.jpg" height="70" width="70">
          <p class="text-para">Furnitures</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Kitchen & dinning">
          <img src="icons/Home Appliances/Kitchen & dinning.jpg" height="70" width="70">
          <p class="text-para">Kitchen & dinning</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=TV">
          <img src="icons/Home Appliances/TV.jpg" height="70" width="70">
          <p class="text-para">TV</p>
        </a>
        </div>
      </div>
