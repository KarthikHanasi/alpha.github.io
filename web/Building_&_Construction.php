    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Bricks">
          		<img src="icons/Building & Construction/Bricks.jpg" height="80" width="80">
          		<p class="text-para">Bricks</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Cement">
          <img src="icons/Building & Construction/cement.jpg" height="70" width="70">
          <p class="text-para">Cement</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Ceramic & tiles">
          <img src="icons/Building & Construction/Ceramic & tiles.jpg" height="70" width="70">
          <p class="text-para">Ceramic tiles</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Construction Machines">
          <img src="icons/Building & Construction/Construction Machines.jpg" height="70" width="70">
          <p class="text-para">Construction Machines</p>
        </a>
        </div>
          <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Doors & plywoods">
          <img src="icons/Building & Construction/Doors & plywoods.jpg" height="70" width="70">
          <p class="text-para">Doors & plywoods</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Hardwares">
          <img src="icons/Building & Construction/Hardwares.jpg" height="70" width="70">
          <p class="text-para">Hardwares</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Pipes">
          <img src="icons/Building & Construction/Pipes.jpg" height="70" width="70">
          <p class="text-para">Pipes</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Steel Bars">
          <img src="icons/Building & Construction/Steel Bars.jpg" height="70" width="70">
          <p class="text-para">Steel Bars</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Windows">
          <img src="icons/Building & Construction/Windows.jpg" height="70" width="70">
          <p class="text-para">Windows</p>
        </a>
        </div>
