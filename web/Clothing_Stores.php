    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Kids">
          		<img src="icons/Clothing stores/Kids.jpg" height="70" width="70">
          		<p class="text-para">Mens</p>
      		</a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Men">
          <img src="icons/Clothing stores/Men.jpg" height="70" width="70">
          <p class="text-para">Womens</p>
        </a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Women">
          <img src="icons/Clothing stores/Women.jpg" height="70" width="70">
          <p class="text-para">Womens</p>
        </a>
        </div>
