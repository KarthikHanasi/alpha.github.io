    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Pet Accessories">
          <img src="icons/Hotels/Pet Accessories.jpg" height="70" width="70">
          <p class="text-para">Pet Accessories</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Pet Shops">
          <img src="icons/Pets/Pet Shops.jpg" height="70" width="70">
          <p class="text-para">Pet Shops</p>
        </a>
        </div>
