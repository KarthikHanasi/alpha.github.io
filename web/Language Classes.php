  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-sm-2">
        	<a href="category_details.php?id=Deutsche">
          		<img src="icons/Language Classes/Deutsche.jpg" height="70" width="70">
          		<p class="text-para">Deutsche</p>
      		</a>
        </div>

        <div class="col-sm-2">
          <a href="category_details.php?id=English">
          <img src="icons/Language Classes/English.jpg" height="70" width="70">
          <p class="text-para">English</p>
        </a>
        </div>

        <div class="col-sm-2">
          <a href="category_details.php?id=francais">
          <img src="icons/Language Classes/francais.jpg" height="70" width="70">
          <p class="text-para">francais</p>
        </a>
        </div>
