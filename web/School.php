    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=English Higher Primary Schools">
          		<img src="icons/Education/English Higher Primary Schools.jpg" height="70" width="70">
          		<p class="text-para">English Higher Primary Schools</p>
      		</a>
        </div>
          <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=English Primary Schools">
              <img src="icons/Education/English Primary Schools.jpg" height="70" width="70">
              <p class="text-para">English Primary Schools</p>
          </a>
        </div>
             <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=English Residential Schools">
              <img src="icons/Education/English Residential Schools.jpg" height="70" width="70">
              <p class="text-para">English Residential Schools</p>
          </a>
        </div>
              <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Kannada Higher Primary Schools">
              <img src="icons/Education/Kannada Higher Primary Schools.jpg" height="70" width="70">
              <p class="text-para">Kannada Higher Primary Schools</p>
          </a>
        </div>
               <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Kannada Primary Schools">
              <img src="icons/Education/Kannada Primary Schools.jpg" height="70" width="70">
              <p class="text-para">Kannada Primary Schools</p>
          </a>
        </div>
               <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Kannada Residential Schools">
              <img src="icons/Education/Kannada Residential Schools.jpg" height="70" width="70">
              <p class="text-para">Kannada Residential Schools</p>
          </a>
        </div>
