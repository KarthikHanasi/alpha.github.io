      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="category_details.php?id=Ayurvedic">
          		<img src="icons/Hospitals/Ayurvedic.jpg" height="70" width="70">
          		<p class="text-para">Ayurvedic</p>
      		</a>
        </div>
         <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Children Hospitals">
          <img src="icons/Hospitals/Children Hospitals.jpg" height="70" width="70">
          <p class="text-para">Children Hospitals</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Dental">
          <img src="icons/Hospitals/Dental.jpg" height="70" width="70">
          <p class="text-para">Dental</p>
        </a>
        </div>

        <div class="col-4 col-sm-2 col-md-2">
          <a href="category_details.php?id=Eye Cares">
          <img src="icons/Hospitals/Eye Cares.jpg" height="70" width="70">
          <p class="text-para">Eye Cares</p>
        </a>
        </div>
      </div>
