    ...
    <div class="modal-content">
      ...
      <div class="row text-center">
        ...
        <div class="col-4 col-sm-2 col-md-2">
        	<a href="Play-Homes.php">
          		<img src="icons/Education/Arts Colleges.jpg" height="70" width="70">
          		<p class="text-para">Play Homes</p>
      		</a>
        </div>
